...
export default defineSchema({
    ...
    users: defineTable({
        ...
        status: v.optional(v.union(v.literal('active'), v.literal('inactive'), v.literal('suspended'), v.literal('deleted'))),
        ...
        loginAttempts: v.optional(v.array(v.object({
            success: v.boolean(),
            ip: v.string(),
            timestamp: v.number(),
        }))),
    ...
    conversations: defineTable({
        ...
        status: v.union(v.literal('active'), v.literal('archived'), v.literal('resolved'), v.literal('escalated')),
    ...
    messages: defineTable({
        ...
        agentMetadata: v.optional(v.object({
            agentId: v.id('agents'),
            agentName: v.string(),
            confidence: v.number(),
    ...
    knowledge: defineTable({
        type: v.union(v.literal('product'), v.literal('service'), v.literal('faq'), v.literal('documentation'), v.literal('policy')),
        title: v.string(),
        content: v.string(),
    ...
    analytics: defineTable({
        type: v.union(v.literal('conversation'), v.literal('message'), v.literal('user'), v.literal('agent'), v.literal('system')),
        event: v.string(),

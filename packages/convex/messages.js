...
export const searchMessages = query({
    args: {
        ...
        role: v.optional(v.union(v.literal('user'), v.literal('assistant'), v.literal('system'), v.literal('tool'))),
        limit: v.optional(v.number()),
    },
    handler: async (ctx, args) => {
        ...
        messages = messages.filter((m) => m.content.toLowerCase().includes(searchLower) && !m.deletedAt);
